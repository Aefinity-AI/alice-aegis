...
16 claims total, 16 with a verified existing primary log file.
...
| 6 | Quality cost, integer-dominant HYBRID path (f32 attention), BitNet-2B — 2B all-integer not yet measured (spec §9) | +0.7408% PPL (30.934140 vs 30.706665), digest 0x24C4E510A86659D6 | A21 | i5-10210U crosvm | `docs/hardware_logs/cis1_e2_bitnet2b_int_vs_float_ppl_i5-10210U_crosvm_2026-08-01.log` | yes |
