...
**Submit this one first.** The companion CIS-2 paper cites it; CIS-2's bibliography gets the arXiv identifier from this submission before it goes up. Companion artifacts: https://github.com/Aefinity-AI/cis2-spec/releases/tag/v0.3b

**Build check (2026-09-09):** `cis1-arxiv.tar.gz` extracts and builds standalone with pdflatex, 27 pages, 0 errors, no undefined citations. Five small overfull hboxes (4.8-9.4pt) inside evidence-table cells; cosmetic, no clipping.
