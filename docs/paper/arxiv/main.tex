...
\textbf{A standing invitation.} The project maintains a public falsification challenge: find any
...
\textbf{The falsification challenge.} The author maintains a standing, public
challenge (\texttt{CHALLENGE.md}): find any machine on which a conforming build
