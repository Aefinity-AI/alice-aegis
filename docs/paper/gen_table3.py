...
Why this isn't a pure mechanical scrape of the ledger:
  ...
  docs/CIS1_PAPER_OUTLINE.md §4-6 against program/RESEARCH_LEDGER.md rows A19-A34
...
# and quality"), cross-referenced against program/RESEARCH_LEDGER.md rows A19-A34.
CLAIM_MAP = [
...
A19-A34 and `docs/CIS1_PAPER_OUTLINE.md` §4-6. Do not hand-edit this file —
