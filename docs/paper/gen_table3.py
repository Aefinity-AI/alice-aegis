...
Why this isn't a pure mechanical scrape of the ledger:
  ...
  docs/CIS1_PAPER_OUTLINE.md §4-6 against program/RESEARCH_LEDGER.md rows A19-A39
...
# and quality"), cross-referenced against program/RESEARCH_LEDGER.md rows A19-A39.
CLAIM_MAP = [
