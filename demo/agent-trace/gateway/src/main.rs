...
// `src/capability.rs` and ENFORCEMENT.md. This is the SAFE-11 fix for the
// safe-10 MAJOR finding (cross-shim capability-token confusion): a token
// minted here for TOOL=file no longer verifies at tool_shim_shell or
// tool_shim_http.
//
